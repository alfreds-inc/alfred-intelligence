...
describe("setupSkills", () => {
  ...
  it("displays a clear empty state note when all skill dependencies are ready", async () => {
    ...
    expect(emptyStateNote?.message).toContain("zolven-intelligence skills list --verbose");
    expect(emptyStateNote?.message).toContain("zolven-intelligence skills check");
  });
